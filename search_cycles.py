...
def main():
    ...
    parser.add_argument("--prefix_file", type=str, default="ngram_sorted.pkl")
    ...
    with open(args.prefix_file, "rb") as f:
        prefix_and_counts = pickle.load(f)

    for prefix, count in tqdm(prefix_and_counts, ncols=0):
        raw_text = " ".join(prefix)
